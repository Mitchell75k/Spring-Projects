    ...
    <body>
        <div class="container bg-dark" style="display: flex; flex-direction: column; justify-content: center; justify-self: center; padding: 2%; margin-top: 20px; height: fit-content;">
            <div style="display: flex;flex-direction: row; margin-top: 30px; margin-bottom: 15px;">
                <h1 class="text-warning">All Tables: </h1>
                <a class="btn btn-danger " style="margin-top: 10px; margin-left: 600px;" href="/logout">Log Out</a>
            </div>
                    ...
                    <tbody style="background-color: antiquewhite;">
                        <c:forEach items="${allTables}" var="table">
                            <tr>
                                ...
                                <td><c:out value="${table.user.userName}"></c:out></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
            ...
            <a style="margin-top: 20px;" href="/home/yourTables">See your tables</a>
        </div>
    </body>
</html>
